...
p1 = flexible_process("p1", efficiency, cf, S, T, 1)
f4 = transfer_flow("n5", "n2")
f9 = process_flow("n6", "p1", 2.0, 0.0)
...
p5 = online_process("p5", efficiency, cf, S, T, 0.1, 1, 1, 0.2, 8.0, 0)
f10 = process_flow("p3", "n2", 2.0, 10.0)
f11a = process_flow("n5", "p5", 4.0, 2.0)
